import { convertRomanNumeral } from '../../../src/2023/04-apr/room2';
...
describe('Test converter', () => {
  ...
  it('Should equal 444', () => {
    expect(convertRomanNumeral('CDXLIV')).toEqual(444);
  });
  ...
  it('Should equal 3999', () => {
    expect(convertRomanNumeral('MMMCMXCIX')).toEqual(3999);
  });
});
